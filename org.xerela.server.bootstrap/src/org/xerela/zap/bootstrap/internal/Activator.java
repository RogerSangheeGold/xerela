...
package org.xerela.zap.bootstrap.internal;
...
import org.xerela.crates.Crate;
import org.xerela.crates.CrateException;
import org.xerela.crates.CrateStarterElf;
import org.xerela.crates.InstallLocation;
...
public class Activator implements BundleActivator
{
    ...
    private static final String ADD_LIB_PATH = "xerela.library.path.add"; //$NON-NLS-1$
    ...
    {
        TimeZone timeZone = TimeZone.getTimeZone(System.getProperty("org.xerela.zap.timezone", "GMT+0")); //$NON-NLS-1$ //$NON-NLS-2$
     ...
     * expiration semantic on their re-packaged version of Xerela.  This code is never used
     * by the "official" Xerela open source release because we run without restriction.  It
     ...
     * named "zef.dat" (Xerela expiration file) which resides in the OSGi configuration area
    ...
    {
        // Do not remove.  This code is unused by Xerela in it's default configuration, but is used by integration partners.
