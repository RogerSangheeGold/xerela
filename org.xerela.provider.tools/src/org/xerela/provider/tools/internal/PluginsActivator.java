 ...
 * 
 */
package org.xerela.provider.tools.internal;
...
import org.xerela.provider.scheduler.Scheduler;
import org.xerela.provider.tools.IPluginManager;
import org.xerela.provider.tools.IPluginProvider;
import org.xerela.provider.tools.PluginProvider;
...
public class PluginsActivator implements BundleActivator, SynchronousBundleListener
{
    ...
    private static final String EXTENSION_POINT_ID = "org.xerela.provider.plugins"; //$NON-NLS-1$
