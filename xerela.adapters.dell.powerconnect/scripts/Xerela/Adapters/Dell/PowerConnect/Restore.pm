package Xerela::Adapters::Dell::PowerConnect::Restore;
...
use Xerela::Adapters::Dell::PowerConnect::Disconnect
	qw(disconnect);
use Xerela::Logger;
...
sub restore_via_tftp
{
	...
	push(@responses, Xerela::Response->new('The copy operation was completed successfully', \&_finish));
