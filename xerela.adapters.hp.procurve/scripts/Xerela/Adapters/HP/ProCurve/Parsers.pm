package Xerela::Adapters::HP::ProCurve::Parsers;

use strict;
use warnings;
use Xerela::Adapters::Utils qw(strip_mac);
...
Xerela::Adapters::HP::ProCurve::Parsers

=head1 SYNOPSIS

	use Xerela::Adapters::HP::ProCurve::Parsers;
...
ProCurve device responses and print out Xerela model elements.
...
Uses the HP ProCurve startup and running configs to put together a Xerela
...
the Xerela interfaces model.

=item C<parse_stp>

Uses "show spanning-tree" information
from ProCurve switches to populate the Xerela STP model.
