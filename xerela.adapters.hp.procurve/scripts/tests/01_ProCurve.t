...
use Xerela::Adapters::HP::ProCurve::Parsers qw(parse_chassis create_config parse_system parse_interfaces parse_stp parse_snmp parse_vlan_info);
use Xerela::TestElf;
use DataProCurveStack qw($responsesHP2500);

my $schema = "../../../org.xerela.adapters/schema/model/xerela-common.xsd";

my $ns = ' xmlns="http://www.xerela.org/model/common/1.0"
  xmlns:core="http://www.xerela.org/model/core/1.0"
  xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
  xsi:schemaLocation="http://www.xerela.org/model/common/1.0 ' . $schema . '"';

my $doc = "ProCurveTest.xml";

my $tester = Xerela::TestElf->new( $responsesHP2500, $doc );

$tester->core_model_test( "ProCurve Core Test", ( \&parse_system, \&create_config ) );
$tester->xpath_test( "/XerelaElementDocument/core:systemName",          "hp2524" );
$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:version", "F.05.17" );
$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:osType",  "ProCurve" );
$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:make",    "HP" );
$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:name",    "/sw/code/build/info(s02)" );
$tester->xpath_test( "/XerelaElementDocument/core:biosVersion",         "F.01.01" );
$tester->xpath_test( "/XerelaElementDocument/core:deviceType",          "Switch" );
$tester->xpath_test( "/XerelaElementDocument/core:contact",             "Changed1" );
$tester->xpath_test( "/XerelaElementDocument/core:configRepository/core:config[core:name='running-config']/core:context",    "active" );
$tester->xpath_test( "/XerelaElementDocument/core:configRepository/core:config[core:name='running-config']/core:mediaType",  "text/plain" );
$tester->xpath_test( "/XerelaElementDocument/core:configRepository/core:config[core:name='running-config']/core:promotable", "false" );
$tester->xpath_test( "/XerelaElementDocument/core:configRepository/core:config[core:name='startup-config']/core:context",    "boot" );
$tester->xpath_test( "/XerelaElementDocument/core:configRepository/core:config[core:name='startup-config']/core:mediaType",  "text/plain" );
$tester->xpath_test( "/XerelaElementDocument/core:configRepository/core:config[core:name='startup-config']/core:promotable", "true" );

$tester = Xerela::TestElf->new( $responsesHP2500, $doc, $ns, $schema );
