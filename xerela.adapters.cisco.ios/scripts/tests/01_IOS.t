...
use Xerela::Adapters::Cisco::IOS::Parsers
...
sub ios_tests
{
	...
	my $tester = Xerela::TestElf->new( $in, $doc );
	$tester->core_model_test( "IOS Core Test", ( \&parse_system, \&create_config ) );
	$tester->xpath_test( "/XerelaElementDocument/core:systemName",                                                            "cisco2610-LAB" );
	$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:version",                                                   "12.2(12e)" );
	$tester->xpath_test( "/XerelaElementDocument/core:deviceType",                                                            "Router" );
	$tester->xpath_test( "/XerelaElementDocument/core:contact",                                                               "pitest1" );
	...
	$tester->xpath_test( "/XerelaElementDocument/core:biosVersion",                                                           "11.3(2)XA4" );
	$tester->xpath_test( "/XerelaElementDocument/core:lastReboot",                                                            "730944003" );

	$tester = Xerela::TestElf->new( $in, $doc, $ns, $schema );
	...
	my $tester = Xerela::TestElf->new( $in, $doc, $ns, $schema );
