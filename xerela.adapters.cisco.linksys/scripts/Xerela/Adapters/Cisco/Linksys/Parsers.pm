package Xerela::Adapters::Cisco::Linksys::Parsers;

use strict;
use warnings;
use Xerela::Adapters::Utils qw(mask_to_bits strip_mac get_mask get_port_number trim get_interface_type getUnitFreeNumber get_crep strip_mac);
use XML::Twig;
use Switch;
...
Xerela::Adapters::Cisco::Linksys::Parsers

=head1 SYNOPSIS

	use Xerela::Adapters::Cisco::Linksys::Parsers;
	parse_chassis( $responses, $xmlPrinter );	

=head1 DESCRIPTION

Module with many static methods that take in a hash of
Linksys HTML documents and print out Xerela model elements.
...
Creates a Xerela common configuration repository
