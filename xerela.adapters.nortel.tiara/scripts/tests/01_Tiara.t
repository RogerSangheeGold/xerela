...
use Xerela::Adapters::Nortel::Tiara::Parsers
...
sub tiara_tests
{
	...
	my $tester = Xerela::TestElf->new( $responses, $doc );
	$tester->core_model_test( "Tiara Core Test", ( \&parse_system, \&create_config ) );
	$tester->xpath_test( "/XerelaElementDocument/core:systemName", 															  "Tasman-1200" );
	$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:version",                          "r8.2.1" );
	$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:osType",                          "TiOS" );
	$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:make",                          "Tasman" );
	$tester->xpath_test( "/XerelaElementDocument/core:deviceType",                               "Router" );
	$tester->xpath_test( "/XerelaElementDocument/core:contact",                              "change2" );
	...
	$tester = Xerela::TestElf->new( $responses, $doc, $ns, $schema );
