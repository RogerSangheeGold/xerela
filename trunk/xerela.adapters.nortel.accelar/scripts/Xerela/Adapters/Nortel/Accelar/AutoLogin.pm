package Xerela::Adapters::Nortel::Accelar::AutoLogin;
...
sub _initial_connection
{
	...
	my @responses = ();
	push(@responses, Xerela::Response->new('sername:\\s*$|ogin:\\s*$', \&_send_username));
...
sub _send_password
{
	...
	# Specify the responses to check for
	my @responses = ();
	push(@responses, Xerela::Response->new('sername:\s*$|ogin\s*$:', $INVALID_CREDENTIALS));
