...
sub accelar_tests
{
	...
	$tester->xpath_test( "/XerelaElementDocument/core:systemName",          "Accelar-1100" );
	$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:make",    "Nortel" );
	$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:version", "2.0.0" );
	$tester->xpath_test( "/XerelaElementDocument/core:biosVersion",         "v2.0.0" );
	$tester->xpath_test( "/XerelaElementDocument/core:deviceType",          "Router" );
	$tester->xpath_test( "/XerelaElementDocument/core:contact",             "satish" );

	$tester->xpath_test( "/XerelaElementDocument/core:configRepository/core:config[core:name='config']/core:context",    "active" );
	$tester->xpath_test( "/XerelaElementDocument/core:configRepository/core:config[core:name='config']/core:mediaType",  "text/plain" );
	$tester->xpath_test( "/XerelaElementDocument/core:configRepository/core:config[core:name='config']/core:name",       "config" );
	$tester->xpath_test( "/XerelaElementDocument/core:configRepository/core:config[core:name='config']/core:promotable", "false" );
