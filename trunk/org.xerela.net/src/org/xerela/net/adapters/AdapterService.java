...
import org.xerela.net.snmp.DiscoveryMapping;
import org.xerela.net.snmp.DiscoveryMapping.DiscoverySource;
import org.xerela.protocols.ProtocolSetElf;
...
public final class AdapterService implements IAdapterService
{
     ...
     */
    public static final String GENERIC_ADAPTER_ID = "Xerela::Adapters::Generic::SNMP";
    public static final String BASE_ADAPTER_ID = "Xerela::Adapters::BaseAdapter";
