...
use Xerela::Adapters::Enterasys::VerticalHorizon::Parsers
...
sub vh_tests
{
	...
	$tester->xpath_test( "/XerelaElementDocument/core:systemName", 			 "Enterasys Vertical Horizon" );
	$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:name",  	 "VerticalHorizon" );
	$tester->xpath_test( "/XerelaElementDocument/core:deviceType",           "Switch" );
	$tester->xpath_test( "/XerelaElementDocument/core:contact",              'java.lang.Thread.sleep(50);' );
	$tester->xpath_test( "/XerelaElementDocument/core:configRepository/core:config[core:name='config']/core:context",   "active" );
	$tester->xpath_test( "/XerelaElementDocument/core:configRepository/core:config[core:name='config']/core:mediaType", "application/x-compressed" );
