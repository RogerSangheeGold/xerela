...
sub foundryfastiron_tests
{
	...
	$tester->xpath_test( "/XerelaElementDocument/core:systemName",                                                              "BigIron" );
	$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:make",                                                        "Foundry" );
	$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:version",                                                     "07.6.02T53" );
	$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:osType",                                                      "Iron Software" );
	$tester->xpath_test( "/XerelaElementDocument/core:biosVersion",                                                             "07.06.02" );
	$tester->xpath_test( "/XerelaElementDocument/core:deviceType",                                                              "Router" );
	$tester->xpath_test( "/XerelaElementDocument/core:contact",                                                                 "gfarris" );
