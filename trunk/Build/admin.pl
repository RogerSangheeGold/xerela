...
sub shell
{
	print "Xerela Administrative Shell - ^VERSION^\n";
	login();
	print "\n";
	...
	return {
	   ...
	   #        },
		...
		"create" => {
			cmds => {
				"user" => {
					desc => 'Create a new Xerela user.',
					proc => \&create_user,
				},
				"role" => {
					desc => 'Create a new Xerela security role.',
					proc => \&create_role,
				},
			},
		...
		"modify" => {
            cmds => {
                ...
                "user" => {
                    desc => 'Modify an existing Xerela user. (not yet implemented)',
                    proc => \&modify_user,
                },
                "role" => {
                    desc => 'Modify an existing Xerela security role. (not yet implemented)',
                    proc => \&modify_role,
                },
            },
		...
		"delete" => {
			cmds => {
				"user" => {
					desc => 'Delete a Xerela user.',
					proc => \&delete_user,
				},
				"role" => {
					desc => 'Delete a user-defined Xerela role.',
					proc => \&delete_role,
				},
			},
		...
		"list" => {
			...
			cmds => {
				"users" => {
					desc => 'List users defined in Xerela.',
					proc => \&list_users,
				},
				"roles" => {
					desc => 'List roles defined in Xerela.',
					proc => \&list_roles,
				}
			},
		},
