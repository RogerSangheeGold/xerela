...
use Xerela::Adapters::Nortel::Passport::Parsers
...
sub nortelpassport_tests
{
	...
	$tester->xpath_test( "/XerelaElementDocument/core:systemName",           "Passport-8606" );
	$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:fileName", "/pcmcia/p80a3500.img" );
	$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:make",     "Nortel" );
	$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:name",     "Passport-8006" );
	$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:version",  "3.5.0.0" );
	$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:osType",   "Passport" );
	$tester->xpath_test( "/XerelaElementDocument/core:deviceType",           "Switch" );
	$tester->xpath_test( "/XerelaElementDocument/core:contact",              "support\@nortelnetworks.com" );
	$tester->xpath_test( "/XerelaElementDocument/core:configRepository/core:config[core:name='config.cfg']/core:context",   "boot" );
	$tester->xpath_test( "/XerelaElementDocument/core:configRepository/core:config[core:name='config.cfg']/core:mediaType", "application/multipart" );
