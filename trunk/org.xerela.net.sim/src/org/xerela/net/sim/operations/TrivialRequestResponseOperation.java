...
public abstract class TrivialRequestResponseOperation extends AbstractOperation
{
    ...
    /* (non-Javadoc)
     * @see org.xerela.net.sim.interactions.IOperation#tearDown()
     */
    ...
    /* (non-Javadoc)
     * @see org.xerela.net.sim.interactions.IOperation#getProtocolSession(java.lang.String)
     */
    ...
    private class TelnetSession implements ITelnetSession
    {
        ...
        /* (non-Javadoc)
         * @see org.xerela.net.sim.telnet.ITelnetSession#open(java.nio.channels.SocketChannel)
         */
        ...
        /* (non-Javadoc)
         * @see org.xerela.net.sim.telnet.ITelnetSession#write(byte[], int, int)
         */
        ...
        /* (non-Javadoc)
         * @see org.xerela.net.sim.telnet.ITelnetSession#close()
         */
