package Xerela::Adapters::Enterasys::SSR;
...
use Xerela::Adapters::Enterasys::SSR::AutoLogin;
use Xerela::Adapters::Enterasys::SSR::Parsers
  qw(parse_routing create_config parse_local_accounts parse_chassis parse_filters parse_snmp parse_system parse_interfaces parse_static_routes parse_vlans parse_stp);
use Xerela::Adapters::Enterasys::SSR::Disconnect qw(disconnect);
use Xerela::Adapters::Enterasys::SSR::GetConfig qw(get_config);
use Xerela::Adapters::Enterasys::SSR::Restore;
...
sub commands
{
	...
	my $result = Xerela::Adapters::GenericAdapter::execute_cli_commands( 'Enterasys SSR Switch Routers', $cliProtocol, $commands, $devicePromptRegex . '|(#|\$|>)\s*$' );
...
sub _connect
{
	...
	my $devicePromptRegex = Xerela::Adapters::Enterasys::SSR::AutoLogin::execute( $cliProtocol, $connectionPath );
