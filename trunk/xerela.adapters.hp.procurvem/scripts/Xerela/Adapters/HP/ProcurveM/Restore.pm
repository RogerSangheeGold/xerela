package Xerela::Adapters::HP::ProcurveM::Restore;
...
sub restore_via_tftp
{
	...
	push(@responses, Xerela::Response->new('Validating and Writing Config to FLASH', \&_finish));
...
sub _confirm
{
	...
	my @responses = ();
	push(@responses, Xerela::Response->new('[Ee]rror|[Ff]ail|Peer unreachable', undef, $TFTP_ERROR));
	push(@responses, Xerela::Response->new("Validating and Writing Config to FLASH|$promptRegex", \&_finish));
