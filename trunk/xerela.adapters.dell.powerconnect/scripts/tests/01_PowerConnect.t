...
sub dpc_tests
{
	...
	$tester->xpath_test( "/XerelaElementDocument/core:systemName",              "Dellswitch" );
	$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:make",        "Dell" );
	$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:version",     "1.2.0.6" );
	$tester->xpath_test( "/XerelaElementDocument/core:biosVersion",             "1.0.0.13" );
	$tester->xpath_test( "/XerelaElementDocument/core:deviceType",              "Switch" );
	$tester->xpath_test( "/XerelaElementDocument/core:contact",                 "hoops" );
