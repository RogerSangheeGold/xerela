package Xerela::Adapters::HP::ProCurve::Disconnect;
...
sub _send_exit
{
	...
	my @responses = ();
	push(@responses, Xerela::Response->new('log\s+out\s+\[y\/n\]', \&_send_yes));
	push(@responses, Xerela::Response->new('save.*\[y\/n\]', \&_send_no));
