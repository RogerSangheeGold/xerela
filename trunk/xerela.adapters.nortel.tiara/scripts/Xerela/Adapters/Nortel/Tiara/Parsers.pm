package Xerela::Adapters::Nortel::Tiara::Parsers;

use strict;
use warnings;
use Xerela::Adapters::Utils qw(seconds_since_epoch get_mask get_port_number get_crep trim get_interface_type getUnitFreeNumber);
