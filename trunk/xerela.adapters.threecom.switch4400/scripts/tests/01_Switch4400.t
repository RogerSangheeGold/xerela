...
use Xerela::Adapters::ThreeCom::Switch4400::Parsers
...
sub three_com_tests
{
	...
	$tester->xpath_test( "/XerelaElementDocument/core:systemName",              "3Com4400" );
	$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:make",        "3Com" );
	$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:version",     "3.21" );
	$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:osType",      "3Com" );
	$tester->xpath_test( "/XerelaElementDocument/core:biosVersion",             "2.21" );
	$tester->xpath_test( "/XerelaElementDocument/core:deviceType",              "Switch" );
	$tester->xpath_test( "/XerelaElementDocument/core:contact",                 "chg5" );
