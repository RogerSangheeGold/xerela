package Xerela::Adapters::ThreeCom::Switch4400;
...
use Xerela::Adapters::ThreeCom::Switch4400::GetConfig qw(get_config);
...
use Xerela::Adapters::ThreeCom::Switch4400::Disconnect
	qw(disconnect);
use Xerela::Adapters::ThreeCom::Switch4400::Restore;
