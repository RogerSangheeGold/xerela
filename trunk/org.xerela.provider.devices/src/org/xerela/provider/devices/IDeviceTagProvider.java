 ...
 */
// MULTIPLESTRINGS:OFF
@WebService(name = "DeviceTags", targetNamespace = "http://www.xerela.org/server/devicetags")
...
public interface IDeviceTagProvider
{
     ...
     * @param tag The tag.
     */
    @ZInvocationSecurity(perm = "org.xerela.tags.administer")
     ...
     */
    @ZInvocationSecurity(perm = "org.xerela.devices.tag")
