package Xerela::Adapters::Vyatta::OFR::Disconnect;    
...
Xerela::Adapters::Vyatta::OFR::Disconnect

=head1 SYNOPSIS

    use Xerela::Adapters::Vyatta::OFR::Disconnect
	Xerela::Adapters::Vyatta::OFR::Disconnect::execute($cliProtocol);
