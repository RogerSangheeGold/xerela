...
import org.xerela.provider.tools.IPluginDetailStreamer;
...
import org.xerela.zap.util.ServiceLookupElf;
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException
    {
        ...
        try
        {
            ...
            if (outFile == null)
            {
                ...
                {
                    if (rptDocFile != null && !Boolean.getBoolean("org.xerela.birt.retain.intermediate")) //$NON-NLS-1$
                    {
                        rptDocFile.delete();
                    }
                }
