...
import org.xerela.provider.tools.BasePluginManager;
import org.xerela.provider.tools.PluginDescriptor;
import org.xerela.provider.tools.ZToolProperties;
import org.xerela.server.birt.internal.BirtActivator;
import org.xerela.zap.util.ResourceElf;
...
public class ReportPluginManager extends BasePluginManager
{
    ...
    public IReportEngine getReportEngine(String reportTitle)
    {
        ...
        String level = System.getProperty("org.xerela.birt.loglevel", "WARNING");
