...
sub pix_501_tests
{
	...
	$tester->xpath_test( "/XerelaElementDocument/core:systemName", "pix-501" );
	$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:version",                                                   "6.1(1)" );
	$tester->xpath_test( "/XerelaElementDocument/core:deviceType",                                                            "Firewall" );
	$tester->xpath_test( "/XerelaElementDocument/core:contact",                                                               "xxxxxxxxxx" );
...
sub fwsm_tests
{
	...
	my $tester = Xerela::TestElf->new( $responses, $doc );
	$tester->core_model_test( "SecurityAppliance Core Test", ( \&parse_system, \&create_config ) );
	$tester->xpath_test( "/XerelaElementDocument/core:systemName", "ceige" );
	$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:version",                                                   "3.1(1)" );
	$tester->xpath_test( "/XerelaElementDocument/core:deviceType",                                                            "Firewall" );
	$tester->xpath_test( "/XerelaElementDocument/core:contact",                                                               "BrentMills" );
	$tester->xpath_test( "/XerelaElementDocument/core:configRepository/core:config[core:name='running-config']/core:context", "active" );
	$tester->xpath_test( "/XerelaElementDocument/core:configRepository/core:config[core:name='startup-config']/core:context", "boot" );
