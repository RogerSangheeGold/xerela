...
sub extremeswitch_tests
{
	...
	$tester->xpath_test( "/XerelaElementDocument/core:systemName", 															  "MIA-Extreme300" );
	$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:version",                                                   "7.4e.3.5" );
	$tester->xpath_test( "/XerelaElementDocument/core:biosVersion", 														  "5.1" );
	$tester->xpath_test( "/XerelaElementDocument/core:contact", 														  	  "Pitest3" );
