package Xerela::Adapters::Extreme::Switch::AutoLogin;
...
sub _initial_connection
{
	...
	push(@responses, Xerela::Response->new('(#|\$)\s*$', \&_disable_cli_paging));
...
Xerela::Adapters::Extreme::Switch::AutoLogin - An example autologin module

=head1 SYNOPSIS

    use Xerela::Adapters::Extreme::Switch;
	my $cli_protocol = Xerela::CLIProtocolFactory::create( $connection_path );
	my $prompt_regex = Xerela::Adapters::Extreme::Switch::execute( $cli_protocol, $connection_path );
