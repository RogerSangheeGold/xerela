package Xerela::Adapters::CheckPoint::SecurePlatform::Parsers;

use strict;
use warnings;
use Xerela::Adapters::Utils qw(seconds_since_epoch mask_to_bits get_port_number trim get_interface_type);
use Xerela::Adapters::Unix::ParsingUtils;
...
sub parse_system
{
	...
	Xerela::Adapters::Unix::ParsingUtils::parse_last_reboot( $in->{uptime}, $out );
}
