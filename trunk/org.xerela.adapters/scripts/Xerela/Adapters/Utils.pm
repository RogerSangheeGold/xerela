...
sub get_interface_type
{
	...
	# given an interface type, figures out a valid Xerela type that will
...
Xerela::Adapters::Utils - General Utility Methods for Adapters
...
adapter parsing modules to produce output that will pass the Xerela
model schema.
...
guess as the proper Xerela interface type.
