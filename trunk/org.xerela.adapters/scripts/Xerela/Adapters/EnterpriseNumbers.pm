package Xerela::Adapters::EnterpriseNumbers;
...
Xerela::Adapters::EnterpriseNumbers

=head1 SYNOPSIS

    use Xerela::Adapters::EnterpriseNumbers;
	my $enterpriseName = Xerela::Adapters::EnterpriseNumbers::get_enterprise_name(".1.3.6.1.4.1.352");
