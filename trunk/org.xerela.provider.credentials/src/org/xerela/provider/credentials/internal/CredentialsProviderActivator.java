 ...
 * under the License.
 * 
 * Copyright the Xerela Project (www.xerela.org)
 */

package org.xerela.provider.credentials.internal;
...
import org.xerela.provider.credentials.DatabaseCredentialsPersister;
import org.xerela.provider.credentials.DatabaseProtocolPersister;
import org.xerela.provider.credentials.ICredentialsProvider;
import org.xerela.provider.credentials.XerelaCredentialsManager;
import org.xerela.provider.credentials.XerelaProtocolManager;
import org.xerela.provider.devices.DeviceProvider;
import org.xerela.provider.devices.IDeviceProvider;
import org.xerela.provider.netman.INetworksProvider;
...
public class CredentialsProviderActivator implements BundleActivator
{
    ...
    public void start(BundleContext context) throws Exception
    {
        ...
        try
        {
            ...
            XerelaCredentialsManager.startup(DatabaseCredentialsPersister.getInstance());
            credentialsManager = XerelaCredentialsManager.getInstance();

            // Startup the ProtocolManager
            XerelaProtocolManager.startup(DatabaseProtocolPersister.getInstance());
            protocolManager = XerelaProtocolManager.getInstance();
        }
        finally
        {
//            if (ownTransaction)
