...
sub cs_500_tests
{
	...
	$tester->xpath_test( "/XerelaElementDocument/core:systemName",								"CS-500" );
	$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:version",							"9.21(3)" );
	$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:name",							"CS Software (CS500-KR)" );
	$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:osType",							"CS500-KR" );
	$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:make",							"Cisco" );
	$tester->xpath_test( "/XerelaElementDocument/core:deviceType",								"Terminal Server" );
	$tester->xpath_test( "/XerelaElementDocument/core:contact",								"tweety" );
	
	$tester->xpath_test( "/XerelaElementDocument/core:configRepository/core:config[core:name='config']/core:context",	"active" );
	$tester->xpath_test( "/XerelaElementDocument/core:configRepository/core:config[core:name='config']/core:promotable",	"true" );
