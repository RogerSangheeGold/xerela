package Xerela::Adapters::Cisco::CS500::Restore;
...
sub restore_via_tftp
{
	...
	my @responses = ();
	push( @responses, Xerela::Response->new( '[Hh]ost or network',							\&_send_host ) );
	push( @responses, Xerela::Response->new( '[Aa]ddress of remote host',					\&_send_tftp_ip ) );
	push( @responses, Xerela::Response->new( '[Nn]ame of configuration file',				\&_send_source_filename ) );
	push( @responses, Xerela::Response->new( '\[confirm\]',									\&_confirm ) );
	push( @responses, Xerela::Response->new( 'timed out|File not found|[Ee]rror|[Ff]ail',	undef, $TFTP_ERROR ) );
...
sub _send_host
{
	...
	push( @responses, Xerela::Response->new( '[Nn]ame of configuration file',				\&_send_source_filename ) );
	push( @responses, Xerela::Response->new( '\[confirm\]',									\&_confirm ) );
	push( @responses, Xerela::Response->new( 'timed out|File not found|[Ee]rror|[Ff]ail|[Hh]ost or network', undef, $TFTP_ERROR ) );
...
sub _send_tftp_ip
{
	...
	push( @responses, Xerela::Response->new( '[Nn]ame of configuration file',				\&_send_source_filename ) );
	push( @responses, Xerela::Response->new( '\[confirm\]',									\&_confirm ) );
	push( @responses, Xerela::Response->new( 'timed out|File not found|[Ee]rror|[Ff]ail|[Hh]ost or network|[Aa]ddress of remote host', undef, $TFTP_ERROR ) );
...
sub _send_source_filename
{
	...
	my @responses = ();
	push( @responses, Xerela::Response->new( '\[confirm\]',									\&_confirm ) );
	push( @responses, Xerela::Response->new( 'timed out|File not found|[Ee]rror|[Ff]ail|[Hh]ost or network|[Aa]ddress of remote host|[Nn]ame of configuration file', undef, $TFTP_ERROR ) );
...
sub _confirm
{
	...
	push( @responses, Xerela::Response->new( 'timed out|File not found|[Ee]rror|[Ff]ail|[Hh]ost or network|[Aa]ddress of remote host|[Nn]ame of configuration file|\[confirm\]', undef, $TFTP_ERROR ) );
