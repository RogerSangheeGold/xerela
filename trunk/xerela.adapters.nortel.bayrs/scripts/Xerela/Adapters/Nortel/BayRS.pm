package Xerela::Adapters::Nortel::BayRS;
...
use Xerela::Adapters::Nortel::BayRS::AutoLogin;
use Xerela::Adapters::Nortel::BayRS::Parsers
  qw(parse_routing create_config parse_local_accounts parse_chassis parse_filters parse_snmp parse_system parse_interfaces parse_static_routes parse_vlans parse_stp);
use Xerela::Adapters::Nortel::BayRS::GetConfig qw(get_config);
use Xerela::Adapters::Nortel::BayRS::Disconnect qw(disconnect);
use Xerela::Adapters::Nortel::BayRS::Restore;
...
sub commands
{
	...
	my $result = Xerela::Adapters::GenericAdapter::execute_cli_commands('BayRS', $cli_protocol, $commands, $prompt_regex.'|(#|\$|>)\s*$');
	disconnect($cli_protocol);
	return $result;
}
...
sub _connect
{
	...
	my $device_prompt_regex =Xerela::Adapters::Nortel::BayRS::AutoLogin::execute( $cli_protocol, $connection_path );
...
Xerela::Adapters::Nortel::BayRS - Example adapter for performing various operations against a particular family of devices.

=head1 SYNOPSIS

    use Xerela::Adapters::Nortel::BayRS;
	Xerela::Adapters::Nortel::BayRS::backup( $backup_document );
