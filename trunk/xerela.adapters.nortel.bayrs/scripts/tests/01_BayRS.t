...
use Xerela::Adapters::Nortel::BayRS::Parsers
...
sub nortel_bayrs_tests
{
	...
	$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:name",                                           "BayRS" );
	$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:version",                                        "14.20" );
	$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:osType",                                         "asn" );
	$tester->xpath_test( "/XerelaElementDocument/core:deviceType",                                                 "Router" );
	$tester->xpath_test( "/XerelaElementDocument/core:contact",                                                    "KrissyKrissyGolicGolic" );
