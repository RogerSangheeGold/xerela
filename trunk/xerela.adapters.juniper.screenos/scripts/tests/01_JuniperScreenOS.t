...
use Xerela::Adapters::Juniper::ScreenOS::Parsers
...
sub juniperscreenos_tests
{
	...
	$tester->xpath_test( "/XerelaElementDocument/core:systemName",           "ns5xp" );
	$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:fileName", "ns5xp.5.0.0r11.0" );
	$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:make",     "Juniper" );
	$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:name",     "NS5XP" );
	$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:version",  "5.0.0r11.0" );
	$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:osType",   "ScreenOS" );
	$tester->xpath_test( "/XerelaElementDocument/core:deviceType",           "Firewall" );
	$tester->xpath_test( "/XerelaElementDocument/core:contact",              "pitest22" );
	$tester->xpath_test( "/XerelaElementDocument/core:configRepository/core:config[core:name='config']/core:context",   "boot" );
