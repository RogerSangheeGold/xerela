package Xerela::Adapters::Juniper::ScreenOS::Restore;
...
use Xerela::Adapters::Juniper::ScreenOS::Disconnect
	qw(disconnect);
use Xerela::Logger;
...
sub restore_via_tftp
{
	...
	my @responses = ();
	push(@responses, Xerela::Response->new('[Ee]rror|[Ff]ail|timeout max|[Aa]bort', undef, $TFTP_ERROR));
	push(@responses, Xerela::Response->new('TFTP Succeeded', \&_finish));
