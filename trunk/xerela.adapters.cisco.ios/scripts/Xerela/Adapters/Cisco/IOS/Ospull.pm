package Xerela::Adapters::Cisco::IOS::Ospull;
...
sub invoke
{
	...
	# Initial connection
	my ( $connectionPath, $filestore ) = Xerela::Typer::translate_document( $ospullDocument, 'connectionPath' );
...
#	my $filehandle = Xerela::Adapters::Utils::_get_output_filehandle( 'IOS', $cliProtocol->get_ip_address(), '_ospull.xml' );
