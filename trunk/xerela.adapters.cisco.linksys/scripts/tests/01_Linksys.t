...
use Xerela::Adapters::Cisco::Linksys::Parsers qw(parse_filters parse_snmp parse_chassis parse_system create_config);
use Xerela::TestElf;
...
$tester->xpath_test( "/XerelaElementDocument/core:systemName",                                    "linksys-vpn" );
$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:version",                           "1.3.7.10" );
$tester->xpath_test( "/XerelaElementDocument/core:deviceType",                                    "Router" );
$tester->xpath_test( "/XerelaElementDocument/core:configRepository/core:config/core:name", "RV042.exp" );
