package Xerela::Adapters::Nortel::BayStack::GetConfig;
...
sub _cli_tftp_running
{
	...
	push( @responses, Xerela::Response->new( 'completed|' . $prompt, \&_finish_running ) );
	push( @responses, Xerela::Response->new( 'Error|TFTP Operation timed', undef, $TFTP_ERROR) );
