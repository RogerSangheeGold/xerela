package Xerela::Adapters::Cisco::WAAS::GetRunningConfig;
...

{
	...
	push(@responses, Xerela::Response->new('[Ii]ncomplete command', \&_specify_all_info));
...
sub _copy_nvram()
{
	...
	my $bad_command_regex = '%\s*[Ii]nvalid input.*[\n\r]+' . $enable_prompt;
	push(@responses, Xerela::Response->new($bad_command_regex, \&_get_running_config_cli));
