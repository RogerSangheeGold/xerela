package Xerela::Adapters::F5::ThreeDNS::AutoLogin;
...
Xerela::Adapters::F5::ThreeDNS::AutoLogin - An example autologin module

=head1 SYNOPSIS

    use Xerela::Adapters::F5::ThreeDNS;
	my $cli_protocol = Xerela::CLIProtocolFactory::create( $connection_path );
	my $prompt_regex = Xerela::Adapters::F5::ThreeDNS::execute( $cli_protocol, $connection_path );
