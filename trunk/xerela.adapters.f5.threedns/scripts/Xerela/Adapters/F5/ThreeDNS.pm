package Xerela::Adapters::F5::ThreeDNS;
...
use Xerela::Adapters::F5::ThreeDNS::AutoLogin;
use Xerela::Adapters::F5::ThreeDNS::GetBackUpFiles qw(get_backup_files);
use Xerela::Adapters::F5::ThreeDNS::Parsers
  qw(parse_routing create_config parse_local_accounts parse_chassis parse_filters parse_snmp parse_system parse_interfaces parse_static_routes parse_vlans parse_stp);
use Xerela::Adapters::F5::ThreeDNS::Disconnect qw(disconnect);
use Xerela::Adapters::Utils qw(get_model_filehandle close_model_filehandle parse_targz_data);
...
sub commands
{
	...
	my $result = Xerela::Adapters::GenericAdapter::execute_cli_commands( 'ThreeDNS', $cli_protocol, $commands, $enable_prompt_regex );
	disconnect($cli_protocol);
	return $result;
}
...
sub _connect
{
	...
	my $device_prompt_regex = Xerela::Adapters::F5::ThreeDNS::AutoLogin::execute( $cli_protocol, $connection_path );
