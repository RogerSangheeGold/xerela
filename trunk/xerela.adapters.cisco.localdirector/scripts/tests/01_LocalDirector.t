...
sub ld_tests
{
	...
	$tester->xpath_test( "/XerelaElementDocument/core:systemName",              "LocalDir416" );
	$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:make",        "Cisco" );
	$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:version",     "3.2.3" );
	$tester->xpath_test( "/XerelaElementDocument/core:deviceType",              "Load Balancer" );
	$tester->xpath_test( "/XerelaElementDocument/core:contact",                 "PITester1" );
