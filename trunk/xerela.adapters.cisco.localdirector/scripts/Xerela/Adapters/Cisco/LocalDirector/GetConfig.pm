package Xerela::Adapters::Cisco::LocalDirector::GetConfig;
...
sub _get_config_tftp
{
	...
	my @responses = ();
	push(@responses, Xerela::Response->new('\[FAILED\]', undef, $TFTP_ERROR));
	push(@responses, Xerela::Response->new('\[OK\]', \&_finish));
