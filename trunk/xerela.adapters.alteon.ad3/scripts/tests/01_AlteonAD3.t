...
sub alteon_ad3_tests
{
	...
	$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:make",                                           		"Alteon" );
	$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:name",                                           		"AD3" );
	$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:version",                                        		"10.0.33-SSH" );
	$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:osType",                                         		"Alteon" );
	$tester->xpath_test( "/XerelaElementDocument/core:deviceType",                                                		"Switch" );
	$tester->xpath_test( "/XerelaElementDocument/core:configRepository/core:config[core:name='boot']/core:context",     "boot" );
	$tester->xpath_test( "/XerelaElementDocument/core:configRepository/core:config[core:name='image1']/core:mediaType", "application/x-compressed" );
