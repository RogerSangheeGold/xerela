...
use Xerela::Adapters::ThreeCom::CoreBuilder::Parsers
...
sub corebuilder_tests
{
	...
	$tester->xpath_test( "/XerelaElementDocument/core:systemName", 					"SuperStack II Switch-9ECE61" );
	$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:version",	"1.0.1" );
	...
	$tester->xpath_test( "/XerelaElementDocument/core:configRepository/core:config/core:context", 	"active" );
	$tester->xpath_test( "/XerelaElementDocument/core:configRepository/core:config/core:mediaType", "text/plain");
	$tester->xpath_test( "/XerelaElementDocument/core:configRepository/core:config/core:promotable","false");
	$tester->xpath_test( "/XerelaElementDocument/core:configRepository/core:config/core:name", "config");
