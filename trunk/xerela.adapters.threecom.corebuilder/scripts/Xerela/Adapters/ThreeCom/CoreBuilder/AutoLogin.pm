package Xerela::Adapters::ThreeCom::CoreBuilder::AutoLogin;
...
sub _initial_connection
{
	...
	my @responses = ();
	push(@responses, Xerela::Response->new('Select access level \\(read, write, administer\\):', \&_send_username));
	push(@responses, Xerela::Response->new("Sorry, the maximum number of telnet sessions for this system are engaged.", undef, $TOO_MANY_USERS));
