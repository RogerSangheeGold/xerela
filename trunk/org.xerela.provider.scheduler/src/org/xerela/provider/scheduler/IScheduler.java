 ...
 * simple SOAP types.
 */
@WebService(name = "Scheduler", targetNamespace = "http://www.xerela.org/server/scheduler")
@SOAPBinding(style = SOAPBinding.Style.DOCUMENT, parameterStyle = SOAPBinding.ParameterStyle.WRAPPED)
public interface IScheduler
{
    /**
     * Get the enumeration Job types exposed by the Xerela server.
     *
     ...
     *     this Trigger
     */
    @ZInvocationSecurity(perm = "org.xerela.filters.administer")
