package Xerela::Adapters::Nortel::Passport1600::Restore;
...
use Xerela::Adapters::Nortel::Passport1600::Disconnect
	qw(disconnect);
use Xerela::Logger;
...
sub _connect
{
	...
	my $device_prompt_regex = Xerela::Adapters::Nortel::Passport1600::AutoLogin::execute( $cli_protocol, $connection_path );
...
sub restore_via_tftp
{
	...
	my @responses = ();
	push(@responses, Xerela::Response->new('File not found|TFTP Establish session fail|[Ee]rror|[Ff]ail', undef, $TFTP_ERROR));
	push(@responses, Xerela::Response->new('Done\. Press ENTER to continue\.', \&_finish));
