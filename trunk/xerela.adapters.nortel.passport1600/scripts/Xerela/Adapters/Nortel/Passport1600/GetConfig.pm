package Xerela::Adapters::Nortel::Passport1600::GetConfig;
...
sub _get_config_tftp
{
	...
	my @responses = ();
	push(@responses, Xerela::Response->new('Failure!', undef, $TFTP_ERROR));
	#push(@responses, Xerela::Response->new('\.{70,}', undef, $TFTP_ERROR));
	push(@responses, Xerela::Response->new('Upload configuration.*Done\.', \&_finish));
