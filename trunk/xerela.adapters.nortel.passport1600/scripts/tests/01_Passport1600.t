...
sub passport1600_tests
{
	...
	$tester->xpath_test( "/XerelaElementDocument/core:systemName",           "passport1612g" );
	$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:make",     "Nortel" );
	$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:name",     "Passport-1612G" );
	$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:version",  "1.2.1.0" );
	$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:osType",   "Passport" );
	$tester->xpath_test( "/XerelaElementDocument/core:biosVersion",			 "0.00.003" );
	$tester->xpath_test( "/XerelaElementDocument/core:deviceType",           "Switch" );
	$tester->xpath_test( "/XerelaElementDocument/core:contact",              "pablo" );
