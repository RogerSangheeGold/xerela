...
public final class AdapterEndpointElf
{
    ...
    public static <T> T getEndpoint(Class<T> type, String deviceType)
    {
        try
        {
            ...
            String remoteNilScheme = System.getProperty("org.xerela.nil.remoteScheme", "https");
            String remoteNilIP = System.getProperty("org.xerela.nil.remoteIp", "localhost");
            String remoteNilPort = System.getProperty("org.xerela.nil.remotePort", "8080");
