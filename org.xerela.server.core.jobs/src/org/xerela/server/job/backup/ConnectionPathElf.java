...
import org.xerela.net.client.Credentials;
import org.xerela.net.client.FileServer;
import org.xerela.net.client.FileServers;
import org.xerela.net.client.Protocol;
import org.xerela.net.client.Protocols;
import org.xerela.net.utils.FileServerInfo;
 ...
 * internal Xerela <code>Protocol</code>, and <code>Credential</code> objects into a SOAP-compatible
...
public final class ConnectionPathElf
{
     ...
     * @param xerelaProtocolSet The internal Xerela <code>ProtocolSet</code> object to use against the device specified by the IP
     ...
     * @param xerelaCredentialSet The internal Xerela <code>CredentialSet</code> object to use against the device specified by the IP
    ...
    public static ConnectionPath generateSoapConnectionPath(String host, ProtocolSet xerelaProtocolSet, CredentialSet xerelaCredentialSet)
    {
        // CHECKSTYLE:ON
        ...
        if (host == null || xerelaProtocolSet == null || xerelaCredentialSet == null)
        {
            return null;
        }
        ...
        // Convert the internal Xerela protocol set object into an array of SOAP-compatible protocol objects
        Protocol[] soapProtocols = ProtocolElf.convertProtocolsToSoapProtocols(xerelaProtocolSet);
        Protocols protos = new Protocols();
        Collections.addAll(protos.getProtocol(), soapProtocols);
        connectionPath.setProtocols(protos);

        // Convert the internal Xerela credential set object into an array of SOAP-compatible credential objects
        Credential[] soapCredentials = CredentialElf.convertCredentialsToSoapCredentials(xerelaCredentialSet);
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////
        //
        // Special case: Add on Xerela TFTP and FTP server information if the protocol is either TFTP or FTP
