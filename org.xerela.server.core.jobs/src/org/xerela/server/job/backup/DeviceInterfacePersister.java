...
import org.xerela.provider.devices.InterfaceIpAddress;
...
public class DeviceInterfacePersister implements IBackupPersister
{
    ...
    static
    {
        ...
        pathsOfInterest.add("/XerelaElementDocument/interfaces/interface"); //$NON-NLS-1$
        pathsOfInterest.add("/XerelaElementDocument/interfaces/interface/name"); //$NON-NLS-1$
        pathsOfInterest.add("/XerelaElementDocument/interfaces/interface/adminStatus"); //$NON-NLS-1$
        pathsOfInterest.add("/XerelaElementDocument/interfaces/interface/interfaceIp/ipConfiguration/ipAddress"); //$NON-NLS-1$
    }
