package Xerela::Adapters::Adtran::NetVanta::Restore;
...
sub restore_via_tftp
{
	...
	push( @responses, Xerela::Response->new( '[Ss]ource filename',							\&_send_source_filename ) );
	push( @responses, Xerela::Response->new( 'Timed out waiting|File not found|[Ee]rror',	undef, $TFTP_ERROR ) );
...
sub _send_tftp_ip
{
	...
	my @responses = ();
	push( @responses, Xerela::Response->new( '[Ss]ource filename',							\&_send_source_filename ) );
	push( @responses, Xerela::Response->new( 'Timed out waiting|File not found|[Ee]rror|[Aa]ddress of remote host',	undef, $TFTP_ERROR ) );
...
sub _send_source_filename
{
	...
	my @responses = ();
	push( @responses, Xerela::Response->new( 'Transfer complete', \&_finish ) );
	push( @responses, Xerela::Response->new( 'Timed out waiting|File not found|[Ee]rror|[Aa]ddress of remote host|[Ss]ource filename', undef, $TFTP_ERROR ) );
