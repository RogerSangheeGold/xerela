package Xerela::Adapters::Nortel::Passport1600::Parsers;

use strict;
use warnings;
use Xerela::Adapters::Utils qw(mask_to_bits seconds_since_epoch get_mask get_port_number trim get_interface_type get_crep getUnitFreeNumber parseCIDR strip_mac);
