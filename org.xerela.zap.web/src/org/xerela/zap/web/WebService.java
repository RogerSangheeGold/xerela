...
import org.xerela.zap.util.BundleFinderHelper;
import org.xerela.zap.web.internal.ZResourceHandler;
...
{
    public static final String EXTENSION_NAMESPACE = "org.xerela.zap.web";
    ...
    public WebService(BundleContext context) throws Exception
    {
        ...
        String jettyXml = System.getProperty("org.xerela.zap.web.jetty.xml", "jetty.xml");
