package Xerela::Adapters::Cisco::Three005;
...
use Xerela::Adapters::Cisco::Three005::GetConfig qw(get_config);
use Xerela::Adapters::Cisco::Three005::Disconnect qw(disconnect);
use Xerela::Adapters::Cisco::Three005::MenuElf qw(enter_menu);
use Xerela::Adapters::Cisco::Three005::Parsers
  qw(parse_routing create_config parse_local_accounts parse_chassis parse_filters parse_snmp parse_system parse_interfaces parse_static_routes parse_vlans parse_stp);
use Xerela::Adapters::Cisco::Three005::Restore;
...
sub commands
{
	...
	my $result = Xerela::Adapters::GenericAdapter::execute_cli_commands( 'Three005', $cli_protocol, $commands, $prompt_regex.'|(#|\$|>)\s*$' );
	disconnect($cli_protocol);
	return $result;
}
...
Xerela::Adapters::Cisco::Three005 - Example adapter for performing various operations against a particular family of devices.

=head1 SYNOPSIS

    use Xerela::Adapters::Cisco::Three005;
	Xerela::Adapters::Cisco::Three005::backup( $backup_document );
...
Contributor(s): asharma, rkruse, Dylan White (dylamite@xerela.org)
Date: Sep 29, 2007
