...
sub aruba_tests
{
	...
	$tester->xpath_test( "/XerelaElementDocument/core:systemName",              "Aruba800" );
	$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:fileName",    "1158273822234.da.cfg" );
	$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:make",        "Aruba" );
	$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:version",     "2.5.3.0" );
	$tester->xpath_test( "/XerelaElementDocument/core:biosVersion",             "1.1.3" );
	$tester->xpath_test( "/XerelaElementDocument/core:deviceType",              "Switch" );
	$tester->xpath_test( "/XerelaElementDocument/core:contact",                 "microsoft" );
