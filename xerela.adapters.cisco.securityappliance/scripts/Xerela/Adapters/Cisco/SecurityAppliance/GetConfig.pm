package Xerela::Adapters::Cisco::SecurityAppliance::GetConfig;
...
use Xerela::Logger;
use Xerela::Adapters::Utils qw(create_empty_file create_unique_filename escape_filename);
...
sub _get_config_tftp
{
	...
	push(@responses, Xerela::Response->new('Error opening nvram', undef, $NVRAM_CORRUPTION_ERROR));
	push(@responses, Xerela::Response->new('Error|Unrecognized command', undef, $TFTP_ERROR));
	push(@responses, Xerela::Response->new('% Invalid input detected at', undef, $INSUFFICIENT_PRIVILEGE));
	push(@responses, Xerela::Response->new('[Uu]sage:', \&_write_net));
	...
	push(@responses, Xerela::Response->new('[Dd]estination [Ff]ilename', \&_specify_destination_file));
	push(@responses, Xerela::Response->new('bytes copied in [\d\.]+ secs|OK|#\s*', \&_finish));
...
sub _write_net()
{
	...
	push(@responses, Xerela::Response->new('Error|Unrecognized command', undef, $TFTP_ERROR));
	push(@responses, Xerela::Response->new('% Invalid input detected at', undef, $INSUFFICIENT_PRIVILEGE));
        push(@responses, Xerela::Response->new('Timed out', undef, $TFTP_ERROR));
	push(@responses, Xerela::Response->new('OK|#\s*', \&_finish));
...
sub _specify_destination_file()
{
	...
	# Specify the responses to check for
	my @responses = ();
	push(@responses, Xerela::Response->new('Error|Unrecognized command|[Rr]emote host|[Dd]estination [Ff]ilename', undef, $TFTP_ERROR));
	push(@responses, Xerela::Response->new('bytes copied in [\d\.]+ secs|OK|#\s*', \&_finish));
...
sub _specify_tftp_address
{
	...
	# Specify the responses to check for
	my @responses = ();
	push(@responses, Xerela::Response->new('Error|Unrecognized command|[Ss]ource [Ff]ilename|[Rr]emote host', undef, $TFTP_ERROR));
	push(@responses, Xerela::Response->new('[Dd]estination [Ff]ilename', \&_specify_destination_file));
	push(@responses, Xerela::Response->new('bytes copied in [\d\.]+ secs|OK|#\s*', \&_finish));
...
sub _specify_source_file
{
	...
	# Specify the responses to check for
	my @responses = ();
	push(@responses, Xerela::Response->new('Error|Unrecognized command|[Ss]ource [Ff]ilename', undef, $TFTP_ERROR));
	push(@responses, Xerela::Response->new('[Dd]estination [Ff]ilename', \&_specify_destination_file));
	push(@responses, Xerela::Response->new('[Rr]emote host', \&_specify_tftp_address));
	push(@responses, Xerela::Response->new('bytes copied in [\d\.]+ secs|OK|#\s*', \&_finish));
