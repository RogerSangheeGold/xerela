package Xerela::Adapters::Extreme::Switch::Parsers;
use strict;
use warnings;
use Xerela::Adapters::Utils qw(seconds_since_epoch get_mask get_port_number strip_mac trim get_interface_type trim);
...
Xerela::Adapters::Extreme::Switch::Parsers

=head1 SYNOPSIS

	use Xerela::Adapters::Extreme::Switch::Parsers qw(parse_routing create_config parse_local_accounts parse_chassis parse_filters parse_snmp parse_system parse_interfaces parse_static_routes parse_vlans parse_stp);
