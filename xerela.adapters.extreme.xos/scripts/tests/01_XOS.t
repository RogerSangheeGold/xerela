...
sub xos_tests
{
	...
	$tester->xpath_test( "/XerelaElementDocument/core:systemName",                                                           "SummitX450-24t" );
	$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:version",                                                  "11.2.3.3" );
	$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:fileName",                                                 "primary.cfg" );
	$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:name",                                                     "ExtremeWare XOS" );
	$tester->xpath_test( "/XerelaElementDocument/core:biosVersion",                                                          "1.0.0.9" );
	$tester->xpath_test( "/XerelaElementDocument/core:deviceType",                                                           "Router" );
	$tester->xpath_test( "/XerelaElementDocument/core:contact",                                                              'support@extremenetworks.com' );
	$tester->xpath_test( "/XerelaElementDocument/core:configRepository/core:config[core:name='primary.cfg']/core:context",   "active" );
	$tester->xpath_test( "/XerelaElementDocument/core:configRepository/core:config[core:name='primary.cfg']/core:mediaType", "text/plain" );
