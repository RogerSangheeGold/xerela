...
sub vxworks_tests
{
	...
	$tester->xpath_test( "/XerelaElementDocument/core:systemName", 														"Aironet_340" );
	$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:make", 												"Cisco" );
	$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:name",                                            	"AP340" );
	$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:version",                                             "11.21" );
	$tester->xpath_test( "/XerelaElementDocument/core:deviceType",                                                      "Wireless Access Point" );
	$tester->xpath_test( "/XerelaElementDocument/core:contact",                                                         "Brent Mills" );
