package Xerela::Adapters::Juniper::JUNOS::AutoLogin;
...
Xerela::Adapters::Juniper::JUNOS::AutoLogin - Automates the connection and authentication with a Juniper JUNOS device.

=head1 SYNOPSIS

    use Xerela::Adapters::Juniper::JUNOS;
	my $cli_protocol = Xerela::CLIProtocolFactory::create( $connection_path );
	my $prompt_regex = Xerela::Adapters::Juniper::JUNOS::execute( $cli_protocol, $connection_path );
