package Xerela::Adapters::Juniper::JUNOS::Disconnect;    
...
Xerela::Adapters::Juniper::JUNOS::Disconnect

=head1 SYNOPSIS

    use Xerela::Adapters::Juniper::JUNOS::Disconnect;
	Xerela::Adapters::Juniper::JUNOS::Disconnect::execute($cliProtocol);
