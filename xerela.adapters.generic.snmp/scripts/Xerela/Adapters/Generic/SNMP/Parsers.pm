package Xerela::Adapters::Generic::SNMP::Parsers;
...
sub parse_chassis
{
	...
	$chassisAsset->{"core:factoryinfo"}->{"core:make"} = Xerela::Adapters::EnterpriseNumbers::get_enterprise_name( $in->{snmp}->{sysObjectId} );
