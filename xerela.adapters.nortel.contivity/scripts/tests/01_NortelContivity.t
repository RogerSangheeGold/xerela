...
sub nortel_contivity_tests
{
	...
	$tester->xpath_test( "/XerelaElementDocument/core:systemName", 			"NYC-Contivity" );
	$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:version", "V06_00.310" );
	$tester->xpath_test( "/XerelaElementDocument/core:biosVersion",         "PO3" );
	$tester->xpath_test( "/XerelaElementDocument/core:deviceType",          "VPN Concentrator" );
