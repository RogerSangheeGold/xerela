package Xerela::Adapters::Nortel::Accelar::GetConfig;
...
sub _get_config_tftp
{
	...
	my @responses = ();
	push(@responses, Xerela::Response->new("fail\\s*$regex",undef, $TFTP_ERROR));
	push(@responses, Xerela::Response->new("success\\s*$regex", \&_finish));
