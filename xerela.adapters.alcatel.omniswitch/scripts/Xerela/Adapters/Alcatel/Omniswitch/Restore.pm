package Xerela::Adapters::Alcatel::Omniswitch::Restore;
...
sub _connect
{
	...
	my $device_prompt_regex = Xerela::Adapters::Alcatel::Omniswitch::AutoLogin::execute( $cli_protocol, $connection_path );
