...
sub catos_5000_tests
{
	...
	$tester->xpath_test( "/XerelaElementDocument/core:systemName", 															  "LON-C5000" );
	$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:version",                                                   "6.4(10)" );
	...
	$tester->xpath_test( "/XerelaElementDocument/core:configRepository/core:config[core:name='config']/core:context", 		  "N/A" );
...
sub catos_5500_tests
{
	...
	$tester->xpath_test( "/XerelaElementDocument/core:systemName", 															  "DAL-C5500" );
	$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:version",                                                   "6.4(2)" );
	$tester->xpath_test( "/XerelaElementDocument/core:deviceType",                                                            "Switch" );
	$tester->xpath_test( "/XerelaElementDocument/core:configRepository/core:config[core:name='config']/core:context", 		  "N/A" );
