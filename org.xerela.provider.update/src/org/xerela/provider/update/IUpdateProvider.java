 ...
 * Contributor(s):
 */
package org.xerela.provider.update;
 ...
 */
@WebService(name = "Update", targetNamespace = "http://www.xerela.org/server/update")
...
public interface IUpdateProvider
{
     ...
     * @param forgeHost The forge server host.  Defaults to "forge.xerela.org".
