package Xerela::Adapters::Nortel::BayRS::Restore;
...
use Xerela::Adapters::Nortel::BayRS::Disconnect
	qw(disconnect);
use Xerela::Logger;
...
sub restore_via_tftp
{
	...
	push(@responses, Xerela::Response->new('completed successfully', \&_finish));
