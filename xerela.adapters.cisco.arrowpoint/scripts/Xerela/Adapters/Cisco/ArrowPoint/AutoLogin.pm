package Xerela::Adapters::Cisco::ArrowPoint::AutoLogin;
...
Xerela::Adapters::Cisco::ArrowPoint::AutoLogin - An example autologin module

=head1 SYNOPSIS

    use Xerela::Adapters::Cisco::ArrowPoint;
	my $cli_protocol = Xerela::CLIProtocolFactory::create( $connection_path );
	my $prompt_regex = Xerela::Adapters::Cisco::ArrowPoint::execute( $cli_protocol, $connection_path );
