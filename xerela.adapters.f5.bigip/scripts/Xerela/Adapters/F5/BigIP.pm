package Xerela::Adapters::F5::BigIP;

use strict;

use Xerela::Adapters::F5::BigIP::AutoLogin;
use Xerela::Adapters::F5::BigIP::GetBackUpFiles qw(get_backup_files);
...
sub commands
{
	...
	my $result = Xerela::Adapters::GenericAdapter::execute_cli_commands( 'BigIP', $cli_protocol, $commands, $enable_prompt_regex );
	disconnect($cli_protocol);
	return $result;
}
...
sub _connect
{
	...
	my $device_prompt_regex = Xerela::Adapters::F5::BigIP::AutoLogin::execute( $cli_protocol, $connection_path );
