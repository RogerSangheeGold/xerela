...
use Xerela::Adapters::F5::BigIP::Parsers
  qw(parse_routing create_config parse_local_accounts parse_chassis parse_filters parse_snmp parse_system parse_interfaces parse_static_routes parse_vlans parse_stp);
use Xerela::Adapters::Utils qw(parse_targz_data);
use Xerela::TestElf;
...
sub bigip_tests
{
	...
	$tester->xpath_test( "/XerelaElementDocument/core:systemName","bigip9.inside.eclyptic.com" );
	$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:make","F5" );
	$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:name","BIG-IP" );
	$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:version","9.1.0" );
	$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:osType","BIG-IP" );
	$tester->xpath_test( "/XerelaElementDocument/core:biosVersion","REV. I" );
	$tester->xpath_test( "/XerelaElementDocument/core:deviceType","Load Balancer" );
	$tester->xpath_test( "/XerelaElementDocument/core:contact","SailajaGandra");
	$tester->xpath_test( "/XerelaElementDocument/core:configRepository/core:config[core:name='backup.ucs']/core:context", 		 	  "N/A" );
