package Xerela::Adapters::ThreeCom::Switch4400::GetConfig;
...
sub _get_config_tftp
{
	...
	#push(@responses, Xerela::Response->new('Save of system configuration successful', \&_finish));
	push(@responses, Xerela::Response->new('File Name', \&_specify_source_file));
	push(@responses, Xerela::Response->new('Enter user notes:', \&_specify_download_note));
