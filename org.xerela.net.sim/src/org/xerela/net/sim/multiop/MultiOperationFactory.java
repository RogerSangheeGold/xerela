...
package org.xerela.net.sim.multiop;
...
import org.xerela.net.sim.exceptions.NoSuchFactoryException;
...
import org.xerela.net.sim.operations.OperationManager;
...
public class MultiOperationFactory implements IOperationFactory
{
    ...
    /* (non-Javadoc)
     * @see org.xerela.net.sim.operations.IOperationFactory#createOperation(org.xerela.net.sim.config.WorkingConfig, org.xerela.net.sim.util.IpAddress, org.xerela.net.sim.util.IpAddress)
     */
    ...
    /* (non-Javadoc)
     * @see org.xerela.net.sim.operations.IOperationFactory#enumerateSessions()
     */
    ...
    /* (non-Javadoc)
     * @see org.xerela.net.sim.operations.IOperationFactory#getPathPrefix()
     */
