...
package org.xerela.net.sim.operations;
...
import org.xerela.net.sim.config.Configuration;
import org.xerela.net.sim.config.ConfigurationService;
import org.xerela.net.sim.exceptions.NoSuchOperationException;
import org.xerela.net.sim.exceptions.NoSuchProtocolSessionException;
import org.xerela.net.sim.telnet.ITelnetOutputHandler;
import org.xerela.net.sim.telnet.ITelnetSession;
import org.xerela.net.sim.telnet.TelnetResponse;
import org.xerela.net.sim.util.CharSequenceBuffer;
import org.xerela.net.sim.util.IpAddress;
import org.xerela.net.sim.util.Util;

/**
 * Tests the {@link org.xerela.net.sim.operations} package.
 */
public class OperationTest extends TestCase implements IStateListener
{
    ...
    /* (non-Javadoc)
     * @see org.xerela.net.sim.operations.IStateListener#handle(org.xerela.net.sim.operations.StateEvent)
     */
    ...
    {
        /* (non-Javadoc)
         * @see org.xerela.net.sim.telnet.ITelnetOutputHandler#close()
         */
        ...
        /* (non-Javadoc)
         * @see org.xerela.net.sim.telnet.ITelnetOutputHandler#handleOutput(org.xerela.net.sim.telnet.TelnetResponse)
         */
