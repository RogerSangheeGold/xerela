package Xerela::Adapters::ThreeCom::Switch3300::AutoLogin;
...
sub _initial_connection
{
	...
	my @responses = ();
	push(@responses, Xerela::Response->new('^\s*$', \&_send_enter));
	...
	push(@responses, Xerela::Response->new('Select menu option', \&_get_prompt));
...
sub _send_username
{
	...
	my @responses = ();
	push(@responses, Xerela::Response->new('[Pp]assword:', \&_send_password));
	push(@responses, Xerela::Response->new('[Ii]ncorrect', undef, $INVALID_CREDENTIALS));
