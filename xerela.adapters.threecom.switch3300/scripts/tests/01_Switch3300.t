...
sub three_com_tests
{
	...
	$tester->xpath_test( "/XerelaElementDocument/core:systemName",              "3Com 3300" );
	$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:make",        "3Com" );
	$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:version",     "2.66" );
	$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:osType",      "3Com" );
	$tester->xpath_test( "/XerelaElementDocument/core:biosVersion",             "1.00" );
	$tester->xpath_test( "/XerelaElementDocument/core:deviceType",              "Switch" );
	$tester->xpath_test( "/XerelaElementDocument/core:contact",                 "Eric Basham" );
