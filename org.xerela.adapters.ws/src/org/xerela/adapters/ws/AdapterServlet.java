 ...
 * Contributor(s):
 */
package org.xerela.adapters.ws;
...
import org.xerela.adapters.ws.internal.AdaptersWsActivator;
import org.xerela.stax.STaXFactoriesElf;
...
public class AdapterServlet extends HttpServlet
{
    ...
    private static final String EX_NS = "http://xerela.org/faults/exceptions";
    ...
    private void writeSuccess(HttpServletResponse response, String result, String method) throws IOException, ServletException
    {
        try
        {
            ...
            String ns = "http://www.xerela.org/adapters/" + method;
