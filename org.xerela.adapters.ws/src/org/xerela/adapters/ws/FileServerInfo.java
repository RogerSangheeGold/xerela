 ...
 * the root directory specified can be accessible by the machine running Xerela.  This means that either the file server must be
...
public class FileServerInfo
{
     ...
     * assumed that the root directory specified can be accessible by the machine running Xerela.  This means that either the
