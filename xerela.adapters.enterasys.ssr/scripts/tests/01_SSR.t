...
use Xerela::Adapters::Enterasys::SSR::Parsers
...
sub ssr_tests
{
	...
	$tester->xpath_test( "/XerelaElementDocument/core:systemName",           "IPM-2000" );
	$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:make",     "Motorola" );
	$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:fileName", "boot/xp9075/" );
	$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:version",  "E9.0.7.5" );
	$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:osType",   "IPM" );
	$tester->xpath_test( "/XerelaElementDocument/core:biosVersion",			 "prom-E3.0.0.0" );
	$tester->xpath_test( "/XerelaElementDocument/core:deviceType",           "Switch" );
	$tester->xpath_test( "/XerelaElementDocument/core:contact",              "Change1" );
	$tester->xpath_test( "/XerelaElementDocument/core:configRepository/core:config[core:name='active-config']/core:context",  "active" );
