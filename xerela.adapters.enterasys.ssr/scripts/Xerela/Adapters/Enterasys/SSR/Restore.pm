package Xerela::Adapters::Enterasys::SSR::Restore;
...
use Xerela::Adapters::Enterasys::SSR::Disconnect
	qw(disconnect);
use Xerela::Logger;
...
sub _connect
{
	...
	my $device_prompt_regex = Xerela::Adapters::Enterasys::SSR::AutoLogin::execute( $cli_protocol, $connection_path );
...
sub restore_via_tftp
{
	...
	push(@responses, Xerela::Response->new('overwrite the [Ss]tartup configuration', \&_confirm));
