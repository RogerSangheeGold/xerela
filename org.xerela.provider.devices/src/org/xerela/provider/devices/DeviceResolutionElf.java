...
import static org.xerela.provider.devices.IDeviceResolutionScheme.ATTR_DEVICE_ID;
import static org.xerela.provider.devices.IDeviceResolutionScheme.ATTR_IP_ADDRESS;
import static org.xerela.provider.devices.IDeviceResolutionScheme.ATTR_IP_HIGH;
import static org.xerela.provider.devices.IDeviceResolutionScheme.ATTR_IP_LOW;
    ...
    public static IDeviceResolutionScheme getResolutionScheme(String scheme)
    {
        try
        {
            ...
            if (schemes == null)
            {
                ...
                IConfigurationElement[] configs = reg.getConfigurationElementsFor("org.xerela.provider.devices.deviceResolutionScheme"); //$NON-NLS-1$
