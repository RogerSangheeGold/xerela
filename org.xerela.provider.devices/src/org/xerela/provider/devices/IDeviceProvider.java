 ...
 */
// MULTIPLESTRINGS:OFF
@WebService(name = "Devices", targetNamespace = "http://www.xerela.org/server/devices")
...
public interface IDeviceProvider
{
     ...
     */
    @ZInvocationSecurity(perm = "org.xerela.devices.administer")
    ...
    /**
     * Get a device from Xerela.  Similar to {@link #getDevice(String, String)} except that the
     * IP address that you ask for doesn't have to be the same administrative IP address known to xerela.
