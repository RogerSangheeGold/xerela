...
import org.xerela.provider.devices.DeviceNotifier.DeviceNotification;
import org.xerela.provider.devices.internal.DeviceProviderActivator;
import org.xerela.provider.netman.ManagedNetwork;
...
public class DeviceProvider implements IDeviceProvider
{
    ...
    /**
     * Retrieves a device from Xerela that is associated with the specified device ID.
     * 
