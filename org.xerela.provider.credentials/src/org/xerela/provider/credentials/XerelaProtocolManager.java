...
import org.xerela.net.utils.PortScan;
import org.xerela.protocols.AbstractProtocolManager;
import org.xerela.protocols.IProtocolPersister;
import org.xerela.protocols.NoEnabledProtocolsException;
import org.xerela.protocols.Protocol;
import org.xerela.protocols.ProtocolConfig;
...
/**
 * The {@link XerelaProtocolManager} class extends the functionality laid down by the {@link XerelaProtocolManager} class and provides
 ...
 * @author rkruse
 */
public class XerelaProtocolManager extends AbstractProtocolManager
{
    private static final String ERROR_NOT_INITIALIZED = "The XerelaProtocolManager has not yet been initialized!"; //$NON-NLS-1$

    private static XerelaProtocolManager instance;
    private static Object staticMutex = new Object();

    /**
     * Private default constructor for the {@link XerelaProtocolManager} class to ensure that there is no way to create an instance externally.
     */
    private XerelaProtocolManager()
    {
        // Do nothing.
    }

    /**
     * Retrieves a singleton instance of the {@link XerelaProtocolManager} class.  The {@link XerelaProtocolManager} must be initialized first
     * by using one of the {@link startup} methods.  A {@link RuntimeException} is thrown if the XerelaProtocolManager singleton hasn't been initialized
     * yet.
     *
     * @return The singleton instance of the {@link XerelaProtocolManager} class.
     */
    public static XerelaProtocolManager getInstance()
    {
    ...
    /**
     * Creates an instance of the {@link XerelaProtocolManager} class but allows you to set some
     ...
     * @return The singleton instance of the {@link XerelaProtocolManager} class.
     */
    public static XerelaProtocolManager startup(IProtocolPersister persister)
    {
     ...
     * @return The singleton instance of the {@link XerelaProtocolManager} class.
     */
    public static XerelaProtocolManager startup(IProtocolPersister persister, ISecurityCheck securityCheck)
    {
        instance = new XerelaProtocolManager();
        instance.init(persister, securityCheck);
        return instance;
    }

    /**
     * Initializes the {@link XerelaProtocolManager} class by ensuring that a default {@link ProtocolConfig} object is setup and
     * persisted.
     * 
    ...
    /**
     * Determines which protocols that were determined as being open by a port scanned are actually enabled for use by Xerela and
