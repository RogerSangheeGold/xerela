...
sub hpprocurvem_tests
{
	...
	$tester->xpath_test( "/XerelaElementDocument/core:systemName",           "HP4000M" );
	$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:make",     "HP" );
	$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:name",     "HP ProCurveM" );
	$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:version",  "C.09.16" );
	$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:osType",   "ProCurveM" );
	$tester->xpath_test( "/XerelaElementDocument/core:biosVersion",  		 "C.06.01" );
