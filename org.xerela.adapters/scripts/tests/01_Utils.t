...
use Xerela::Adapters::Utils qw(choose_admin_ip seconds_since_epoch mask_to_bits);
use Xerela::Adapters::EnterpriseNumbers;
...
my $returnValue1 = Xerela::Adapters::EnterpriseNumbers::get_enterprise_name(".1.3.6.1.4.1.29343");
ok( $returnValue1 eq "Grundig SAT-Systems GmbH", "EnterpriseNumbers test 1" );

my $returnValue2 = Xerela::Adapters::EnterpriseNumbers::get_enterprise_name(".1.3.6.1.4.1.352");
