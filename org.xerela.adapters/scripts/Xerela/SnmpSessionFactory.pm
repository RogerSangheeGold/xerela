package Xerela::SnmpSessionFactory;
...
Xerela::SnmpSessionFactory - Creates a Net::SNMP session

=head1 SYNOPSIS

	use Xerela::SnmpSessionFactory;
	my $snmpSession = Xerela::SnmpSessionFactory->create( $connectionPath, $credentials );

=head1 DESCRIPTION

Given a connection path and credentials used in a standard Xerela adapter, the SnmpSessionFactory
