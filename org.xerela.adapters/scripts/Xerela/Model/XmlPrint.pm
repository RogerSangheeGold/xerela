...
<DiscoveryEvent xmlns="http://www.xerela.org/model/telemetry/1.0"
    xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
    xmlns:telemetry="http://www.xerela.org/model/telemetry/1.0"
    xsi:schemaLocation="http://www.xerela.org/model/telemetry/1.0 telemetry.xsd">
END
}
...
sub open_model
{
	...
	{
		print $FILEHANDLE '<XerelaElementDocument xmlns="http://www.xerela.org/model/core/1.0"';
	}
	elsif ( $modeltype ne 'common' )
	{
		print $FILEHANDLE '<' . $modeltype . ':XerelaElementDocument xmlns="http://www.xerela.org/model/common/1.0"';
	}
	else
	{
		print $FILEHANDLE '<XerelaElementDocument xmlns="http://www.xerela.org/model/common/1.0"';
	}
	...
	print $FILEHANDLE ' xmlns:core="http://www.xerela.org/model/core/1.0"';
	print $FILEHANDLE ' xmlns:common="http://www.xerela.org/model/common/1.0"' if ( $modeltype ne "core" );
	print $FILEHANDLE ' xsi:schemaLocation="http://www.xerela.org/model/core/1.0 xerela-core.xsd';
	print $FILEHANDLE ' http://www.xerela.org/model/common/1.0 xerela-common.xsd' if ( $modeltype ne "core" );
...
sub close_model
{
	...
	{
		print $FILEHANDLE "</XerelaElementDocument>\n";
	}
	else
	{
		print $FILEHANDLE "</$modeltype:XerelaElementDocument>\n";
	}
}
...
Xerela::Model::XmlPrint - Utility Module to Print XML Elements from Perl Scalars

=head1 SYNOPSIS

	use Xerela::Model::XmlPrint;
	my $printer = Xerela::Model::XmlPrint::new(\*STDOUT, "common");
	$printer->open_model();
...
print elements from the Xerela model.  Your elements should be small but well formed
hashtables that match the Xerela model schema.
...
EXAMPLES:
	my $printer = Xerela::Model::XmlPrint->new( $filehandle, 'common', "http://www.xerela.org/model/cisco/1.0 cisco.xsd" );
...
Prints out the root XML element of the Xerela model.  After all printing is done you
...
Prints out just the closing tag of the Xerela model.
e.g. "</XerelaElementDocument>"
