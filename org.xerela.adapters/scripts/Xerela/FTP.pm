...
# Specifies that Xerela::FTP is a subclass of Xerela::TransferProtocol
...
sub new
{
	...
	# Turn $this into a Xerela::FTP object
...
Xerela::FTP - FTP client implementation of the Xerela::TransferProtocol interface/abstract base class.
...
Xerela::FTP represents a client implementing the FTP protocol that adheres to the interface specified by the
Xerela::TransferProtocol class.  The core backing of this implementation is the C<Net::FTP> module.
