package Xerela::Addressing::Subnet;
...
=head1 SYNOPSIS
    ...
    my $mask = 24;
	my $subnet = Xerela::Addressing::Subnet->new($host, $bitMask);
...
Builds a Xerela::Addressing::Subnet object from a host and mask.
