package Xerela::Adapters::Enterasys::VerticalHorizon;
...
use Xerela::Adapters::Enterasys::VerticalHorizon::AutoLogin;
use Xerela::Adapters::Enterasys::VerticalHorizon::GetConfig qw(get_config);
use Xerela::Adapters::Enterasys::VerticalHorizon::Parsers
  qw(parse_routing create_config parse_local_accounts parse_chassis parse_filters parse_snmp parse_system parse_interfaces parse_static_routes parse_vlans parse_stp);
use Xerela::Adapters::Enterasys::VerticalHorizon::Restore;
use Xerela::Adapters::Utils qw(get_model_filehandle close_model_filehandle trim);
...
sub commands
{
	...
	my $result = Xerela::Adapters::GenericAdapter::execute_cli_commands('Vertical Horizon', $cli_protocol, $commands, '(#|\$|>)\s*$');
	_disconnect($cli_protocol);
	return $result;
}
...
sub _connect
{
	...
	my $device_prompt_regex = Xerela::Adapters::Enterasys::VerticalHorizon::AutoLogin::execute( $cli_protocol, $connection_path );
