package Xerela::Adapters::Nortel::Passport::GetConfig;
...
sub _get_config_tftp
{
	...
	my @responses = ();
	push(@responses, Xerela::Response->new('Can\'t\s+open', undef, $TFTP_ERROR));
	push(@responses, Xerela::Response->new('>|#', \&_finish));
