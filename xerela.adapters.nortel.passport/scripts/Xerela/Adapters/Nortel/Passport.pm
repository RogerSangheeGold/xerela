package Xerela::Adapters::Nortel::Passport;
...
use Xerela::Adapters::Nortel::Passport::AutoLogin;
use Xerela::Adapters::Nortel::Passport::GetConfig qw(get_config);
use Xerela::Adapters::Nortel::Passport::Parsers
  qw(parse_routing create_config parse_local_accounts parse_chassis parse_filters parse_snmp parse_system parse_interfaces parse_static_routes parse_vlans parse_stp);
use Xerela::Adapters::Nortel::Passport::Disconnect
	qw(disconnect);
use Xerela::Adapters::Nortel::Passport::Restore;
...
sub commands
{
	...
	my $result = Xerela::Adapters::GenericAdapter::execute_cli_commands('Passport', $cli_protocol, $commands, $prompt_regex.'|(#|\$|>)\s*$');
	disconnect($cli_protocol);
	return $result;
}
...
sub restore
{
	...
	Xerela::Adapters::Nortel::Passport::Restore::execute( $connection_path, $cli_protocol, $enable_prompt_regex, $restoreFile );
...
sub _connect
{
	...
	my $device_prompt_regex =Xerela::Adapters::Nortel::Passport::AutoLogin::execute( $cli_protocol, $connection_path );
