package Xerela::Adapters::Nokia::Checkpoint::AutoLogin;
...
sub _initial_connection
{
	...
	push(@responses, Xerela::Response->new('Terminal\s+type\?', \&_send_term_type));
...
Xerela::Adapters::Nokia::Checkpoint::AutoLogin - An example autologin module

=head1 SYNOPSIS

    use Xerela::Adapters::Nokia::Checkpoint;
	my $cli_protocol = Xerela::CLIProtocolFactory::create( $connection_path );
	my $prompt_regex = Xerela::Adapters::Nokia::Checkpoint::execute( $cli_protocol, $connection_path );
