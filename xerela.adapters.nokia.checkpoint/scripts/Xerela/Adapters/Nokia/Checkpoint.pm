package Xerela::Adapters::Nokia::Checkpoint;
...
use Xerela::Adapters::Nokia::Checkpoint::AutoLogin;
use Xerela::Adapters::Nokia::Checkpoint::GetConfig qw(get_config);
use Xerela::Adapters::Nokia::Checkpoint::Parsers
  qw(parse_routing create_config parse_local_accounts parse_chassis parse_filters parse_snmp parse_system parse_interfaces parse_static_routes parse_vlans parse_stp);
use Xerela::Adapters::Nokia::Checkpoint::Disconnect
	qw(disconnect);
...
sub backup
{
	...
	$fts				= "config";
	my $config_filename = "$fts.xerela_backup";
...
sub commands
{
	...
	my $result = Xerela::Adapters::GenericAdapter::execute_cli_commands('Checkpoint', $cli_protocol, $commands, '(#|\$|>)\s*$');
	disconnect($cli_protocol);
	return $result;
}
...
sub _connect
{
	...
	my $device_prompt_regex =Xerela::Adapters::Nokia::Checkpoint::AutoLogin::execute( $cli_protocol, $connection_path );
