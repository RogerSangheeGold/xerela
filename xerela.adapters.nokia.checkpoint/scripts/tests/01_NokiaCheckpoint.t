...
use Xerela::Adapters::Nokia::Checkpoint::Parsers
...
sub nokiacheckpoint_tests
{
	...
	$tester->xpath_test( "/XerelaElementDocument/core:systemName",                                                 "IP440Lab" );
	$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:make",                                           "Nokia" );
	$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:name",                                           "FCS6" );
	$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:version",                                        "3.6" );
	$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:osType",                                         "Checkpoint" );
	$tester->xpath_test( "/XerelaElementDocument/core:deviceType",                                                 "Firewall" );
	$tester->xpath_test( "/XerelaElementDocument/core:contact",                                                    "pitest" );
	$tester->xpath_test( "/XerelaElementDocument/core:biosVersion",                                                "4S4EB2X0.86A.00" );
	$tester->xpath_test( "/XerelaElementDocument/core:configRepository/core:config[core:name='config.tar.gz']/core:context",   "N/A" );
	$tester->xpath_test( "/XerelaElementDocument/core:configRepository/core:config[core:name='config.tar.gz']/core:mediaType", "application/x-compressed" );
