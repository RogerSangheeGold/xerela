...
use Xerela::Adapters::Marconi::ATMSwitch::Parsers
...
sub atmswitch_tests
{
	...
	$tester->xpath_test( "/XerelaElementDocument/core:systemName",           "ESX-3000-2 CONFIG-A" );
	$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:make",     "Marconi" );
	$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:name",     "ForeThought" );
	$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:version",  "7.1.0" );
	$tester->xpath_test( "/XerelaElementDocument/core:osInfo/core:osType",   "FT" );
	$tester->xpath_test( "/XerelaElementDocument/core:biosVersion",			 "FT7.1" );
	$tester->xpath_test( "/XerelaElementDocument/core:deviceType",           "Switch" );
	$tester->xpath_test( "/XerelaElementDocument/core:contact",              "Unknown" );
