package Xerela::Adapters::Marconi::ATMSwitch;
...
use Xerela::Adapters::Marconi::ATMSwitch::AutoLogin;
use Xerela::Adapters::Marconi::ATMSwitch::Parsers
  qw(parse_routing create_config parse_local_accounts parse_chassis parse_filters parse_snmp parse_system parse_interfaces parse_static_routes parse_vlans parse_stp);
#use Xerela::Adapters::Marconi::ATMSwitch::Disconnect qw(disconnect);
use Xerela::Adapters::Marconi::ATMSwitch::GetConfig qw(get_config);
...
sub commands
{
	...
	my $result = Xerela::Adapters::GenericAdapter::execute_cli_commands( 'ATM Switch', $cliProtocol, $commands, $devicePromptRegex . '|(#|\$|>)\s*$' );
...
sub _connect
{
	...
	my $devicePromptRegex = Xerela::Adapters::Marconi::ATMSwitch::AutoLogin::execute( $cliProtocol, $connectionPath );
